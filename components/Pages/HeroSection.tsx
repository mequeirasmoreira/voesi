      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-16 px-6 pb-24 pt-10 lg:flex-row lg:items-center">
        ...
        <div className="relative flex flex-1 justify-center">
          <div className="relative grid w-full max-w-md gap-6">
            <div className="rounded-3xl border border-white/10 bg-white/10 p-6 text-slate-900 shadow-xl shadow-cyan-500/10 backdrop-blur">
              ...
              <div className="mt-6 flex items-center justify-between text-sm font-semibold text-cyan-800">
